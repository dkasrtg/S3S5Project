...
<html lang="en">
  <head>
    ...
    <link
      rel="shortcut icon"
      href="${pageContext.request.contextPath}/template/assets/images/favicon.ico"
    />
    <link
    ...
    />
    <link
      href="${pageContext.request.contextPath}/template/assets/css/icons.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
  ...
  <body class="fixed-left">
      ...
      <div class="left side-menu">
        ...
        <div class="topbar-left">
          <div class="text-center bg-logo">
            ...
            ><!-- <a href="index.html" class="logo"><img src="${pageContext.request.contextPath}/template/assets/images/logo.png" height="24" alt="logo"></a> -->
          </div>
        </div>
        <div class="sidebar-user">
          <img
            src="${pageContext.request.contextPath}/template/assets/images/users/avatar-6.jpg"
            alt="user"
            ...
            <ul>
              ...
              <li>
                <a href="calendar.html" class="waves-effect"
                  ><i class="dripicons-to-do"></i><span> Calendar</span></a
                >
              </li>
              <li class="menu-title">Components</li>
              <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"
                  ><i class="dripicons-jewel"></i> <span>UI Elements </span
              ...
              <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"
                  ><i class="dripicons-blog"></i><span> Forms </span
              ...
              <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"
                  ><i class="dripicons-graph-pie"></i><span> Charts </span
                  ><span class="float-right"
                    ><i class="mdi mdi-chevron-right"></i></span
                ></a>
                <ul class="list-unstyled">
              ...
              <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"
                  ><i class="dripicons-trophy"></i> <span>Icons </span
                  ><span class="float-right"
                    ><i class="mdi mdi-chevron-right"></i></span
                ></a>
                <ul class="list-unstyled">
              ...
              <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"
                  ><i class="dripicons-card"></i><span> Tables </span
                  ><span class="float-right"
                    ><i class="mdi mdi-chevron-right"></i></span
                ></a>
                <ul class="list-unstyled">
              ...
              <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"
                  ><i class="dripicons-map"></i><span> Maps </span
              ...
              <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"
                  ><i class="dripicons-copy"></i><span> Pages </span
                  ><span class="float-right"
                    ><i class="mdi mdi-chevron-right"></i></span
                ></a>
                <ul class="list-unstyled">
              ...
              <ul class="list-inline float-right mb-0">
                ...
                >
                  <a
                    ...
                    >English
                    <img
                      src="${pageContext.request.contextPath}/template/assets/images/flags/us_flag.jpg"
                      class="ml-2"
                      height="16"
                      alt=""
                  /></a>
                  ...
                  >
                    <a class="dropdown-item" href="#"
                      ><img
                        src="${pageContext.request.contextPath}/template/assets/images/flags/italy_flag.jpg"
                        alt=""
                        height="16"
                      /><span>Italian </span></a
                    ><a class="dropdown-item" href="#"
                      ><img
                        src="${pageContext.request.contextPath}/template/assets/images/flags/french_flag.jpg"
                        alt=""
                        height="16"
                      /><span>French </span></a
                    ><a class="dropdown-item" href="#"
                      ><img
                        src="${pageContext.request.contextPath}/template/assets/images/flags/spain_flag.jpg"
                        alt=""
                        height="16"
                      /><span>Spanish </span></a
                    ><a class="dropdown-item" href="#"
                      ><img
                        src="${pageContext.request.contextPath}/template/assets/images/flags/russia_flag.jpg"
                        alt=""
                        height="16"
                      /><span>Russian</span></a
                    >
                  ...
                  >
                    ...
                    <a
                      ...
                      ><div class="notify-icon">
                        <img
                          src="${pageContext.request.contextPath}/template/assets/images/users/avatar-2.jpg"
                          alt="user-img"
                    ...
                    <a
                      ...
                      ><div class="notify-icon">
                        <img
                          src="${pageContext.request.contextPath}/template/assets/images/users/avatar-3.jpg"
                          alt="user-img"
                          class="img-fluid rounded-circle"
                        />
                      </div>
                    ...
                    <a
                      ...
                      ><div class="notify-icon">
                        <img
                          src="${pageContext.request.contextPath}/template/assets/images/users/avatar-4.jpg"
                          alt="user-img"
                          class="img-fluid rounded-circle"
                        />
                      </div>
                ...
                <div class="col-lg-3">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <ul
                        class="list-unstyled list-inline text-center mb-0 mt-3"
                      >
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="row mb-3">
                        <div class="col-sm-6">
                          <p class="mb-0 text-muted font-13">
                            <i class="mdi mdi-album mr-2 text-warning"></i>New
                            Leads
                          </p>
                        </div>
                        <div class="col-sm-6">
                          <p class="mb-0 text-muted font-13">
                            <i class="mdi mdi-album mr-2 text-danger"></i>New
                            Leads Target
                          </p>
                        </div>
                      </div>
                      <div
                        class="progress bg-gradient1 mb-3"
                        style="height: 5px"
                      >
                        <div
                          class="progress-bar bg-gradient3"
                          role="progressbar"
                          style="width: 65%"
                          aria-valuenow="65"
                          aria-valuemin="0"
                      ...
                      <a class="btn btn-primary btn-sm btn-block text-white"
                        >Read More</a
                      >
                    </div>
                  </div>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="border-top-0 text-right">
                                <a href="#" class="btn btn-light btn-sm"
                                  ><i
                                    class="far fa-comments mr-2 text-success"
                                  ></i
                                  >Chat</a
                                >
                              </td>
                            ...
                            <tr>
                              <td>
                                <div class="media">
                                  <img
                                    src="${pageContext.request.contextPath}/template/assets/images/users/avatar-5.jpg"
                                    alt=""
                                    class="thumb-md rounded-circle"
                                  />
                                  <div class="media-body ml-2">
                            ...
                            <tr>
                              <td>
                                <div class="media">
                                  <img
                                    src="${pageContext.request.contextPath}/template/assets/images/users/avatar-1.jpg"
                                    alt=""
                                    class="thumb-md rounded-circle"
                                  />
                                  <div class="media-body ml-2">
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <p class="font-14 text-muted mb-4">
                        <i
                          class="mdi mdi-message-reply text-danger mr-2 font-18"
                        ></i>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="d-sm-flex align-self-center">
                        <img
                          src="${pageContext.request.contextPath}/template/assets/images/widgets/code.svg"
                          alt=""
                          class=""
                          height="100"
                        />
                        <div class="media-body ml-3">
                          ...
                          <p class="text-muted font-13">
                            Contrary to popular belief, generators on Lorem
                ...
                <div class="col-xl-4 col-lg-6">
                  <div class="card timeline-card">
                    <div class="card-body p-0">
                      <div
                        class="bg-gradient2 text-white text-center py-3 mb-4"
                      >
                        <p class="mb-0 font-18">
                          <i class="mdi mdi-clock-outline font-20"></i> This
                          Week's Activity
                        </p>
                      </div>
                    </div>
                    <div class="card-body boxscroll">
                      <div class="timeline">
                        <div class="entry">
                          <div class="title"><h6>10/ Oct</h6></div>
                          <div class="body">
                            <p>
                        ...
                        <div class="entry">
                          <div class="title"><h6>9/ Oct</h6></div>
                          <div class="body">
                            <p>
                              All the Lorem Ipsum generators on the predefined
                              chunks as necessary.....<a
                                href="#"
                                class="text-primary"
                              >
                                Read More</a
                        ...
                        <div class="entry">
                          <div class="title"><h6>8/ Oct</h6></div>
                          <div class="body">
                            <p>
                        ...
                        <div class="entry">
                          <div class="title"><h6>7/ Oct</h6></div>
                          <div class="body">
                            <p class="pb-1">
                              Many desktop publishing packages and web page
                              editors now.....<a href="#" class="text-primary">
                                Read More</a
                              >
                            </p>
                          </div>
                        ...
                        <div class="entry">
                          <div class="title"><h6>6/ Oct</h6></div>
                          <div class="body">
                            <p class="pb-1 mb-0">
                              All the Lorem Ipsum generators on the predefined
                              chunks as necessary.....<a
    ...
    <script src="${pageContext.request.contextPath}/template/assets/js/modernizr.min.js"></script>
    <script src="${pageContext.request.contextPath}/template/assets/js/detect.js"></script>
    <script src="${pageContext.request.contextPath}/template/assets/js/fastclick.js"></script>
    <script src="${pageContext.request.contextPath}/template/assets/js/jquery.slimscroll.js"></script>
    <script src="${pageContext.request.contextPath}/template/assets/js/jquery.blockUI.js"></script>
    <script src="${pageContext.request.contextPath}/template/assets/js/waves.js"></script>
    <script src="${pageContext.request.contextPath}/template/assets/js/jquery.nicescroll.js"></script>
    <script src="${pageContext.request.contextPath}/template/assets/js/jquery.scrollTo.min.js"></script>
    <script src="${pageContext.request.contextPath}/template/assets/plugins/chart.js/chart.min.js"></script>
    <script src="${pageContext.request.contextPath}/template/assets/pages/dashboard.js"></script>
    <!-- App js -->
    <script src="${pageContext.request.contextPath}/template/assets/js/app.js"></script>
  </body>
  <!-- Mirrored from mannatthemes.com/zoogler/vertical/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Nov 2023 17:59:33 GMT -->
</html>
