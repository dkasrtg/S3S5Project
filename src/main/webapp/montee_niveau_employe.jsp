            ...
            <div class="container-fluid">
                  ...
                  <div class="page-title-box">
                    <div class="btn-group float-right">
                      <ol class="breadcrumb hide-phone p-0 m-0">
                        ...
                        <li class="breadcrumb-item active">Monte niveau</li>
                      </ol>
                    </div>
                    <h4 class="page-title">Montee niveau</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="mt-0 header-title">Nouveau montee niveau</h4>
                      <form action="/montee_niveau_employe" method="post">
                        <div class="row">
                          <div class="col-xl-6">
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <form action="/montee_niveau_employe" method="get">
                        <div class="row">
                          <div class="col-xl-6">
                            <div class="form-group row">
                              <label
                      ...
                      >
                        ...
                        <tbody>
                          <c:forEach var="c" items="${vMonteeNiveauEmployes}">
                              <tr>
                                  <td>${c.id}</td>
                                  <td>${c.nomPoste}</td>
