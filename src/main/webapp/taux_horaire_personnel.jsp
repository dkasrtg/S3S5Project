...
<%
List<VTauxHorairePersonnel> vtHorairePersonnels = (List<VTauxHorairePersonnel>) request.getAttribute("vtHorairePersonnels");
%>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    />
    <title>Personnel - Taux horaire</title>
            ...
            <div class="container-fluid">
                  ...
                  <div class="page-title-box">
                    <div class="btn-group float-right">
                      <ol class="breadcrumb hide-phone p-0 m-0">
                        ...
                        <li class="breadcrumb-item active">Taux horaire</li>
                      </ol>
                    </div>
                    <h4 class="page-title">Taux horaire</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <form action="/taux_horaire_personnel" method="get">
                        <div class="row">
                          <div class="col-xl-6">
                      ...
                      <h4 class="mt-0 header-title">Taux horaire employe le </h4>
                      <table
                        id="datatable"
                      ...
                      >
                        ...
                        <tbody>
                          <%
                          for(VTauxHorairePersonnel v : vtHorairePersonnels){
                            %>
                            <tr>
                              <td><%= v.getIdPersonnel()  %></td>
                              <td><%= v.getNomPersonnel()  %> <%= v.getPrenomPersonnel()  %></td>
                              <td><%= v.getNomPoste()  %></td>
                              <td><%= v.getNomNiveau()  %></td>
                              <td><%= v.getDateDebut() %></td>
                              <td><%= v.getTauxHoraire()  %></td>
                            </tr>
                            <%
                          }
                          %>
