                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      >
                        ...
                        <tbody>
                          <%
                          for(VBeneficeMeuble v : vBeneficeMeubles){
                            %>
                            <tr>
                              <td><%= v.getNomMeuble()%></td>
                              <td><%= v.getNomTailleMeuble() %></td>
                              <td><%= v.getPrixDeVente() %></td>
                              <td><%= v.getTotalMateriaux() %></td>
                              <td><%= v.getTotalSalaires() %></td>
                              <td><%= v.getPrixDeRevient() %></td>
                              <td><%= v.getBenefice() %></td>
                            </tr>
                            <%
                          }
