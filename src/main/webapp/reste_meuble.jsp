            ...
            <div class="container-fluid">
              <div class="row">
                <div class="col-sm-12">
                  <div class="page-title-box">
                    ...
                    <h4 class="page-title">Reste Meuble</h4>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <form action="/reste_Meuble" method="get">
                        <div class="row">
                          <div class="col-xl-6">
                      ...
                      <h4 class="mt-0 header-title">Reste meubles le ${date}</h4>
                      <table
                        id="datatable"
                      ...
                      >
                        ...
                        <tbody>
                          <c:forEach var="c" items="${resteMeubles}">
                            <tr>
                              <td>${c.nomMeuble}</td>
