            ...
            <div class="container-fluid">
              ...
              <div class="row">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xl-6"> 
                            <div class="form-group row">
                              ...
                              >
                              <div class="col-sm-10">
                                <select class="form-control" name="id_role_employe">
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="mt-0 header-title">Liste des utilisations</h4>
                      <table
                        id="datatable"
                      ...
                      >
                        ...
                        <tbody>
                          <c:forEach var="c" items="${vUtilisationEmployes}">
                            <tr>
                              <td>${c.id}</td>
                              <td>${c.dateDebut}</td>
                              <td>${c.dateFin}</td>
                              ...
                              <td>${c.nomNiveau}</td>
                              <td>${c.tauxHoraire}</td>
                              <td>${c.dureeUtilisation}</td>
                              <td>${c.salaireTotal}</td>
                            </tr>
                          </c:forEach>
                        </tbody>
                      </table>
